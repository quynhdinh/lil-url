...
- As a signed-in user, I want to view the statistics of my shortened URLs so that I can track their performance.

### 3. Developer User Stories

- As a developer, I want to shorten a long URL using the API so that I can integrate URL shortening into my application.